document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (roles.includes('Cuisinier') || roles.includes('Restaurant'))
        links.push('<a href="cook.html">Interface Cuisinier</a>');
    if (roles.includes('Livreur'))
        links.push('<a href="livreur.html">Interface Livreur</a>');
    if (links.length)
